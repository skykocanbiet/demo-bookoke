			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("Chọn hình ảnh") + '</div>' +
						'<div class="plupload_header_text">' + _("Thêm hình ảnh vào hàng đợi tải lên và nhấp vào nút bắt đầu.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' + _('Tên hình ảnh') + '</td>' +
					'<td class="plupload_cell plupload_file_status">' + _('Trạng thái') + '</td>' +
					'<td class="plupload_cell plupload_file_size">' + _('Kích thước') + '</td>' +
					'<td class="plupload_cell plupload_file_action">&nbsp;</td>' +
				'</tr>' +
				'</table>' +

				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Kéo hình ảnh ở đây.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("Thêm Hình Ảnh") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start">' + _("Bắt Đầu Tải Lên") + '</a>&nbsp;' +
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
			...
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('%d hình ảnh xếp hàng đợi'), up.total.queued));
		}
