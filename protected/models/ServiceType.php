...
/**
 * This is the model class for table "p_service_type".
 *
 * The followings are the available columns in table 'p_service_type':
 * @property integer $id
...
class ServiceType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, image, description, createdate, status_hiden, status', 'safe', 'on'=>'search'),
		);
	}
