...
<div style="position: relative;width: 120px; height: 120px;">
	<img id="stafflistimage" src="<?php echo $baseUrl; ?>/upload/provider/lg/<?php if($model['images']!="") echo $model['images']; else echo "no_avatar.png";?>" class="fl" style="border-radius:100%;">
