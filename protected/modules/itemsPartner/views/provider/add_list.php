...
<div id="myModal" class="modal">
            ...
            <div class="col-sm-12 n1">
               <div class="col-sm-2"  >
                  ...
                  <div id="image-holder" style="margin-top:10px;">
                    ...
                    <img src="<?php echo Yii::app()->request->baseUrl;?>/images/img/placeholder_70x70.gif" id="file_preview_1" style="width:100%;">
  ...
  top: 0px; opacity: 0">
               ...
               <div class="col-sm-2">
                ...
                <div class="col-sm-10 addliast" style="padding-top: 5px;">
                  ...
                  <span class="input-group-addon yellow_hover blue_focus" id="basic-addon3">
                    https://<?php echo $baseUrl;?>/
                  </span>
                  <input type="text"  required class="form-control" name="websubmain" id="websubmain" >
                </div>
                </div>
               <div class="clearfix"></div>
            <hr style="margin-top:5px; margin-bottom:0px;">
            ...
            <!--  <div class="col-sm-4 n1">
                <label>Phone</label>
                <input type="number" class="form-control" name="providerPhone" id="providerPhone">
                 <label>Home-Phone</label>
                <input type="number" class="form-control" name="providerHPhone" id="providerHPhone">
                <label>Email</label>
                <input type="email" class="form-control" name="providerMail" id="providerMail">
            </div>
            ...
            <div class="col-sm-4 n1">
                <label>Zipcode</label>
                <input type="number" class="form-control" name="providerZipcode" id="providerZipcode">
                 <label>X</label>
                <input type="number" step="any" class="form-control" name="providerX" id="providerX">
                  <label>Y</label>
                <input type="number" step="any" class="form-control" name="providerY" id="providerY">
            </div>
