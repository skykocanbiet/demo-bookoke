...
<?php
    ...
    Yii::app()->clientScript->registerCssFile($baseUrl.'/assets_home/mini-website/robo-crop/bootstrap.min.css');
                    ...
                    <div id="wr-miniweb">
				    	<div id="miniweb-content">
							...
							<div class="current-domain">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="#demo1" data-toggle="collapse" id="edit-domain">(Edit)</a>
								 <div id="demo1" class="collapse">
								    <div class="input-group">
					  				<span class="input-group-addon yellow_hover blue_focus" id="basic-addon3">
					  					<?php echo $baseUrl;?>/
					  				</span>
					  				<input type="text" style="position:initial; border-right-radius: 3px; border: solid 1px #ccc;" onchange="updateSubdomain(<?php echo $data['id']?>);" class="form-control" id="sub_domain" aria-describedby="basic-addon3" value="<?php echo $data['sub_domain'] ?>" >
									</div>
								 </div>
							</div>
									...
									<tr>
										...
										<td class="last-column">
											<button type="button" class="button btn btn-info btn-lg btn-open-modal" 
													data-toggle="modal" id="btn-edit-cover">Edit</button>
													<!-- data-target="#myModal" -->
										</td>
									</tr>
									<tr>
										...
										<td class="last-column">
											<button type="button" class="button btn btn-info btn-lg btn-open-modal" 
													data-toggle="modal" data-target="#myModallogo" id="btn-edit-logo">Edit</button>
										</td>
									</tr>
				    	...
				    	<!-- Modal crop avatar -->
						<div id="myModallogo" class="modal fade" role="dialog">
