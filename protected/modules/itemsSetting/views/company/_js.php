...
{    
    ...
    {       
        ...
        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) 
        {
            ...
            {
                type        : 'POST',              
                url         : baseUrl+'/itemsSetting/Company/SearchProvider', 
...
function detailprovider(id){
    ...
    $.ajax({
        type:'POST',
        url: baseUrl+'/itemsSetting/Company/DetailProvider',   
        data: {"id":id},   
   ...
   var evt = window.event || arguments.callee.caller.arguments[0];
    ...
    $("#yes_delete"+id).click(function(e){
        e.preventDefault();
         $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Company/deleteProvider',   
            data: {"id":id},   
...
function updateCustomerImage(id){
    ...
    if (!formData.checkValidity || formData.checkValidity()) {
        jQuery.ajax({           
            type:"POST",
            url: baseUrl+'/itemsSetting/Company/UpdateproviderImage',  
            data:formData,
            datatype:'json',
            success:function(data){             
...
function updateSubdomain(id){
    if(err()){
        ...
        $.ajax({
            type:'POST',
            url:baseUrl+'/itemsSetting/Company/updatesubmain',
...
function updateProvider(id){
    ...
    if(err()){
        ...
        $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/updateProvider',   
...
function updateProviderCountry(id, id_country){
    ...
    if(err()){
        ...
        Id_Country = $('#Id_Country').val();
         ...
         $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/updateProviderCountry',   
...
//var id = document.getElementById("providerCountry").val();
        ...
        $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/CityCoutry1',   
...
//var id = document.getElementById("providerCountry").val();
        ...
        $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/StateCountry1',   
            data: {"code":code, "id":id},  
    ...
    function savecity(id){
     ...
     $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/updateProviderSave',   
...
function savestate(id){
     ...
     $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/updateProviderSaveState',   
...
$('#frm-add-provider').submit(function(e) {
    ...
    if (!formData.checkValidity || formData.checkValidity()) {
        jQuery.ajax({           
            type:"POST",
            url: baseUrl+'/itemsSetting/Providerelitedental/addprovider',  
            data:formData,
            datatype:'json',
            success:function(data){
...
function updateStatus(id){
    ...
    if(err()){
        ...
        $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/updateStatusOn',   
...
function updateStatusOff(id){
    ...
    if(err()){
        ...
        $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/updateStatusOff',   
            data: {"id":id, "status":status},   
...
function updateStatusDistance(id){
    ...
    if(err()){
        ...
        $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/Distance',   
            data: {"id":id},   
...
function updateStatusFeatured(id){
    ...
    if(err()){
        ...
        $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/Featured',   
            data: {"id":id},   
...
function updateStatusMost(id){
    ...
    if(err()){
        ...
        $.ajax({
            type:'POST',
            url: baseUrl+'/itemsSetting/Providerelitedental/Most',   
            data: {"id":id},   
