...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">
            ...
            <li id="profile_configure_nav" class="<?php if($controller == 'csExtensionCall') echo "active"; ?>">
                <a href="<?php echo $baseUrl; ?>/itemsSetting/csExtensionCall/View">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/10_thiet_lap/extension_<?php if($controller == 'csExtensionCall'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                   Extension
                </a>
            </li>
       </ul>
