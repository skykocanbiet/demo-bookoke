...
<div id="box_title_content" class="row clearfix" >
        <label class="col-xs-8 col-sm-9 col-md-9">
            <?php if($model->isNewRecord == 1){ ?>
                <h3>Create Ip Request</h3>
            <?php }else{ ?>
            <h1>Update Ip Request <?php echo $model->id; ?></h1>
            <?php } ?>     
        </label>  
...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textFieldGroup($model,'ip_address',array('widgetOptions'=>array('htmlOptions'=>array('maxlength'=>255,'required'=>'required')))); ?>
