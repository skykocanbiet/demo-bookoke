...
<link rel="stylesheet" href="<?php echo $baseUrl; ?>/js/plupload-master/jquery-ui.css" type="text/css" />
<link rel="stylesheet" href="<?php echo $baseUrl; ?>/js/plupload-master/jquery.ui.plupload.css" type="text/css" />
<script type="text/javascript" src="<?php echo $baseUrl; ?>/js/plupload-master/jquery-ui.min.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl; ?>/js/plupload-master/plupload.full.min.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl; ?>/js/plupload-master/jquery.ui.plupload.js"></script>
<!-- end plupload-master -->
                                ...
                                <div style="margin:0px 2em;">
                                            ...
                                            <h3>Danh sách 
                                                <span style="font-size: 14px;font-weight: normal;">
                                                    ...
                                                    if(Yii::app()->user->getState('group_id') == Yii::app()->params['id_group_dentist']){
                                                        $sumCustomer =  $model->getListSumCustomersByAppointment(Yii::app()->user->getState('user_id'));
                                                    }else{
                                                         $sumCustomer =  $model->getListSumCustomers();
                                                    }
                                                    echo '('.$sumCustomer.')';
                                                    ?>
                                                </span>
                                    ...
                                    <div id="searchCustomerPopup" class="popover bottom open" style="display: none;">                                               
                                        ...
                                        <div class="popover-content">
                                            ...
                                            <input id="iptSearchBirthdate" class="form-control" type="text" placeholder="Ngày sinh">
                                            <input id="iptSearchIdentityCardNumber" class="form-control" type="text" placeholder="CMND/Passport">
                                    ...
                                    <div class="customerSearchHolder">
                                            <div id="customer-search-textbox">
                                                ...
                                                <input type="hidden" id="searchSortCustomer">
