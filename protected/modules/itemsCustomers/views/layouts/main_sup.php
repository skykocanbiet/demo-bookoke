...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">    
            ...
            <li id="profile_configure_nav" class="<?php if($controller == 'review') echo "active"; ?>">
                <a  href="<?php echo Yii::app()->baseUrl.'/itemsCustomers/Review/admin'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/complant_<?php if($controller == 'review'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Đánh giá
                </a>
            </li>

            <li id="profile_configure_nav" class="<?php if($controller == 'complant') echo "active"; ?>">
                <a  href="<?php echo Yii::app()->baseUrl.'/itemsCustomers/Potential/admin'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/review_<?php if($controller == 'complant'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Phàn nàn
                </a>
            </li>
