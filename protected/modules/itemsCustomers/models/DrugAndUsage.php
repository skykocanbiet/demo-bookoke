...
class DrugAndUsage extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_prescription, drug_name', 'required'),
			array('id_prescription, drug_name, morning, noon, afternoon, night', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_prescription, drug_name, morning, noon, afternoon, night', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('noon',$this->noon);
