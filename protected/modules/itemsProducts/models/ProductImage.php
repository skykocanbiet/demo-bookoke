...
class ProductImage extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'rel_product' => array(self::BELONGS_TO,'Product','id_product'),
		);
	}
    ...
    public function deleteImageScaleAndCrop($fileImageDelete){
    	   ...
    	   unlink("upload/product_image/lg/".$fileImageDelete);
		   unlink("upload/product_image/md/".$fileImageDelete);
		   unlink("upload/product_image/sm/".$fileImageDelete);
    }
}
