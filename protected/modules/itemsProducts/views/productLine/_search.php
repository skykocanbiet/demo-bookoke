...
<div id="box_title_content" class="clearfix">
		...
		<?php echo $form->dropDownListGroup($model,'id_product_type',array('widgetOptions'=>array('data'=>CHtml::listData(ProductType::model()->findAll(),'id', 'name'),'htmlOptions'=>array('empty'=>'--Choose Country--','required'=>'required')))); ?>
