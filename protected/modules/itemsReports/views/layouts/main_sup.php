...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">
            ...
            <li id="profile_preview_nav" class="<?php if($controller == 'reportingBusiness') echo "active"; ?>">
                <a href="<?php echo $baseUrl; ?>/itemsReports/reportingBusiness/View" >
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/1_tong_quan/kinh_doanh_<?php if($controller == 'reportingBusiness'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Kinh Doanh
                </a>
            </li>
            <li id="profile_preview_nav" class="<?php if($controller == 'reportingFinance') echo "active"; ?>">
                <a href="<?php echo $baseUrl; ?>/itemsReports/ReportingFinance/view" >
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/7_tai_chinh/dogn_tien_<?php if($controller == 'reportingFinance'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Tài chính
                </a>
            </li>
            ...
            <li id="profile_preview_nav" class="<?php if($controller == 'reportingCustomer') echo "active"; ?>">
                <a href="<?php echo $baseUrl; ?>/itemsReports/ReportingCustomer/View" >
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/khach_hang_<?php if($controller == 'reportingCustomer'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Khách hàng
                </a>
            </li>
