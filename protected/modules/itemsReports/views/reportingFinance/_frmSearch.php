    ...
    <div id="oSrchRight" class="pull-left">
        ...
        <div class="form-group" style="margin-right:20px;">
              ...
              <?php 
                    ...
                    echo CHtml::dropDownList('frm_search_due_requester_date',3,$listdata,array('class'=>'form-control','onChange'=>'changeBranch()'));
...
<script type="text/javascript">
 ...
 $('#frm_search_due_requester_date').click(function () {
    ...
    function changeBranch()
    {
        ...
        jQuery.ajax({   
            type:"POST",
            url:"<?php echo CController::createUrl('reportingFinance/ChangeBranch')?>",
            data:{
