...
/**
 * This is the model class for table "ra_payer".
 *
 * The followings are the available columns in table 'ra_payer':
 * @property integer $id
 ...
 */
class RaPayer extends CActiveRecord
{
	/**
	 ...
	 * @return RaPayer the static model class
	 */
