...
{ 
    ...
    { 
        ...
        return array(
            array('id_invoice, id_service, id_product, id_discount, id_voucher, id_user, id_author, , qty, status', 'numerical', 'integerOnly'=>true),
            array('unit_price, amount, tax', 'numerical'),
            array('description, teeth', 'length', 'max'=>255),
            array('confirm_date', 'safe'),
            // The following rule is used by search(). 
            // @todo Please remove those attributes that should not be searched. 
            array('id, id_invoice, id_service, id_product, id_discount, id_voucher, description, id_user, id_author, create_date, confirm_date, unit_price, amount, teeth, qty, tax, status', 'safe', 'on'=>'search'),
        ); 
    } 
