...
{ 
    ...
    { 
        ...
        return array( 
            array('id_order, id_service, create_date', 'required'),
            array('id_order, id_service, id_product, id_discount, id_voucher, id_user, id_author, qty, status', 'numerical', 'integerOnly'=>true),
            ...
            array('id, id_order, diagnose, id_service, id_product, id_discount, id_voucher, description, id_user, id_author, create_date, confirm_date, unit_price, amount, qty, teeth, tax, status', 'safe', 'on'=>'search'),
        ); 
    } 
