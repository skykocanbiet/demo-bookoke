(function(j, f) {
    ...
    var k = function(r, q) {
        ...
        if (this.o.calendarWeeks) {
            this.picker.find("tfoot th.today, tfoot th.clear").attr("colspan", function(s, t) {
                return parseInt(t) + 1
            })
        }
    ...
    k.prototype = {
        ...
        place: function() {
            ...
            this.element.parents().each(function() {
                var G = j(this).css("z-index");
                if (G !== "auto" && G !== 0) {
                    A.push(parseInt(G))
                }
            });
            var D = Math.max.apply(Math, A) + 10;
            var z = this.component ? this.component.parent().offset() : this.element.offset();
            var E = this.component ? this.component.outerHeight(true) : this.element.outerHeight(false);
            ...
            if (q === "top") {
                ...
                C -= B + parseInt(this.picker.css("padding-top"))
            }
            this.picker.css({
                top: C,
                left: y,
        ...
        _toggle_multidate: function(r) {
            ...
            if (this.o.multidate === 1 && q === 0) {} else {
                if (q !== -1) {
                    this.dates.remove(q)
                } else {
                    this.dates.push(r)
